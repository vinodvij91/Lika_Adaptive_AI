...
const VACCINE_DATASETS: ScRNADataset[] = [
  ...
  { id: "gse201345", name: "Nipah VLP Vaccine Immunogenicity", geoAccession: "GSE201345", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 95432, description: "Virus-like particle (VLP) Nipah vaccine immune cell dynamics", source: "GEO", species: "human", publicationYear: 2023, hasTrajectory: true },
  { id: "gse203789", name: "Nipah Subunit Vaccine Phase II", geoAccession: "GSE203789", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 145678, description: "Phase II HeV-sG-V subunit vaccine with CpG adjuvant scRNA-seq", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse206123", name: "Nipah Viral Vector Vaccine", geoAccession: "GSE206123", disease: "Nipah Vaccine", tissue: "PBMC/Lymph Node", cellCount: 167890, description: "ChAdOx1 NiV viral vector vaccine single-cell atlas", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse208456", name: "Nipah Prime-Boost Strategy", geoAccession: "GSE208456", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 134567, description: "Heterologous prime-boost (DNA prime, protein boost) immune profiling", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse210789", name: "Nipah F/G Protein Vaccine", geoAccession: "GSE210789", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 123456, description: "Fusion (F) and attachment (G) glycoprotein combination vaccine scRNA-seq", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse213012", name: "Nipah mRNA-LNP Booster", geoAccession: "GSE213012", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 156789, description: "mRNA-LNP booster dose immune dynamics in previously vaccinated cohort", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse215345", name: "Nipah Pediatric Vaccine Trial", geoAccession: "GSE215345", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 98765, description: "Age-stratified pediatric Nipah vaccine immune responses", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse217678", name: "Nipah Self-Amplifying RNA Vaccine", geoAccession: "GSE217678", disease: "Nipah Vaccine", tissue: "PBMC", cellCount: 178901, description: "saRNA Nipah vaccine with enhanced immunogenicity profiling", source: "GEO", species: "human", publicationYear: 2024, hasTrajectory: true },
  { id: "gse219901", name: "Nipah Mucosal Vaccine", geoAccession: "GSE219901", disease: "Nipah Vaccine", tissue: "PBMC/Nasal Mucosa", cellCount: 112345, description: "Intranasal Nipah vaccine mucosal and systemic immune atlas", source: "GEO", species: "human", publicationYear: 2025, hasTrajectory: true },
  { id: "gse222134", name: "Nipah Long-term Memory Response", geoAccession: "GSE222134", disease: "Nipah Vaccine", tissue: "PBMC/Bone Marrow", cellCount: 89012, description: "12-month post-vaccination memory B and T cell persistence", source: "GEO", species: "human", publicationYear: 2025, hasTrajectory: true }
];
